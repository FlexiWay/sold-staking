...
export default function Home() {
  return <>
    <div className="w-full flex flex-col items-center justify-start pt-20 gap-4">
      <div className="w-full flex items-center">
        <Image
          ...
          height={140}
          alt=""
          className="max-w-2/4 md:max-w-2/4 lg:max-w-1/4 xl:max-w-1/4 w-2/4 mx-auto pointer-events-none "
        />
      </div>
